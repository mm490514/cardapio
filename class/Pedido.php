...
class Pedido {	
	...
	public function insert(){		
		if($this->item_name) {
			...
			INSERT INTO ".$this->pedidosTable."(`item_id`, `name`, `price`, `quantity`, `cliente_nome`, `observacao`, `order_date`, `order_id`)
			VALUES(?,?,?,?,?,?,?,?)");		
			...
			$stmt->bind_param("issdsssi", $this->item_id, $this->item_name, $this->item_price, $this->quantity, $this->cliente_nome, $this->cliente_observacao, $this->order_date, $this->order_id);
